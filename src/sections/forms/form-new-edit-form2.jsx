        ...
        <Table sx={{ minWidth: '100%' }}>
          <TableBody>
            <TableRow sx={{ border: '1px solid gray' }}>
              ...
              >
                Si está comenzando una nueva orden proceda a realizar el Line Clearance. De no ser
                asi marque No Requerido. Para los part numbers 27-7086 y 27-7141 seleccionen o
                requerido para la Estación de Corte. N oReq Clearance Para los part numbers 27-7105.
                27-7086. 27-7104. 27-7124, 27-7136. 27-7115. 27-7081, 27-7129. 27-
                  ...
                  <Grid item md={7} xs={12} sx={{ backgroundColor: 'rgba(145, 158, 171, 0.12)' }}>
                    ...
                    <ol>
                      ...
                      <li>
                        <Typography variant="subtitle2" sx={{ textAlign: 'left' }}>
                          {' '}
                          Ensamblajes y sub-ensamblajes norelacionadoa l nuevolote se removieron de
                          línea de producción
                        </Typography>
                      </li>
                      <li>
